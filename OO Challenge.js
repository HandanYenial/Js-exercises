...
class Vehicle{
    ...
    toString(){
        return  `The vehicle is ${this.make}, ${this.model} , ${this.year}`;
    }
}
...
//  each motorcycle instance should have a property called numWheels which has 
//  a value of 2. It should also have a revEngine method which returns “VROOM!!!”
...
//  number indicating how many vehicles will fit in the garage. When you create a garage,
